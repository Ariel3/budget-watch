...
class DBHelper extends SQLiteOpenHelper {
    ...
    static class Setting {
        public static int FIRST_DAY_IN_ROUND;
    }
    ...
    public DBHelper(Context context) {
        ...
        String firstDayInMonthStr = prefs.getString("firstDayInMonth", "");
        int firstDayInMonth = 1; // default value
        try {
            firstDayInMonth = Integer.parseInt(firstDayInMonthStr);
        } catch (NumberFormatException e) {
            // If the setting has no value or is otherwise invalid, fall back
            // on a default value
        }
        FIRST_DAY_IN_ROUND = firstDayInMonth;
    }
